		...
		try {
			...
			while (true) {
				...
				case "REGISTRAR_DOCUMENTO":
					...
					// Aumentamos el id de Registro para llevar una referencia(id) de cada uno de los ficheros registrados
					// comprobando ademas que no coincida con el ID de registro de algun fichero ya registrado
